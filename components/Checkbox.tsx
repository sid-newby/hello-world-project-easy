      ...
      <label>
        <input
          ...
          className={classNames(
            // Removed duplicate before:rounded-sm from base styles
            "appearance-none outline-none block relative text-center cursor-pointer m-auto before:block before:absolute before:content-[''] before:bg-[#FFC29F] before:rounded-sm before:border-black after:block after:content-[''] after:absolute after:border-black after:origin-center after:rotate-45",
            {
