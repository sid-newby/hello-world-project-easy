  ...
  return (
    <>
      <div className="relative inline-block text-left">
        <div>
          <button
            ...
            className={classNames(
              "inline-flex w-72 justify-center gap-x-1.5 px-3 py-2 border-[1px] border-[color:white] focus:outline-none focus:shadow-[2px_2px_0px_rgba(0,0,0,1)]",
        ...
        <div
          className={classNames(
            // Removed w-72 which conflicts with w-56
            "absolute right-0 z-10 mt-2 w-56 origin-top-right bg-[color:var(--c-bg)] focus:outline-none shadow-[2px_2px_0px_rgba(0,0,0,1)] border-[1px] border-[color:white] divide-y divide-black",
            { hidden: !open }
          )}
          role="menu"
